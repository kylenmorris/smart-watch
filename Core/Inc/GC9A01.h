#include "main.h"
#include "C:\Users\kylen\gth842\st7789\smart-watch\Drivers\STM32L4xx_HAL_Driver\Inc\stm32l4xx_ll_spi.h"
#include "fonts.h"
...
#define LCD_RST_1 LL_GPIO_SetOutputPin	(	ST7789_RST_GPIO_Port,ST7789_RST_Pin	)			// LCD_RST = 1 , LCD RESET pin
#define LCD_RST_0 LL_GPIO_ResetOutputPin(	ST7789_RST_GPIO_Port,ST7789_RST_Pin	)			// LCD_RST = 0 , LCD RESET pin

#define LCD_CS_1 LL_GPIO_SetOutputPin		(	DISP_CS_GPIO_Port,DISP_CS_Pin		)			// LCD_CS = 1, LCD select pin
#define LCD_CS_0 LL_GPIO_ResetOutputPin	(	DISP_CS_GPIO_Port,DISP_CS_Pin		)			// LCD_CS = 0, LCD select pin

#define LCD_DC_1 LL_GPIO_SetOutputPin		(   ST7789_DC_GPIO_Port,ST7789_DC_Pin		)			// LCD_DC = 1, LCD Data/Command pin
#define LCD_DC_0 LL_GPIO_ResetOutputPin	(	ST7789_DC_GPIO_Port,ST7789_DC_Pin		)			// LCD_DC = 0,LCD Data/Command pin
...
#define DMA_CHANNEL LL_DMA_CHANNEL_4																			//Which DMA channel do you use

#define LL_DMA_ClearFlag_TC LL_DMA_ClearFlag_TC4											//Must match DMA_CHANNEL above
